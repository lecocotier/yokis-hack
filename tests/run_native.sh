...
"${CXX:-g++}" -std=c++11 -fno-exceptions -g "${HOST_OPTIMIZATION:--O0}" -Wall -Wextra -Werror -Wno-unused-parameter -Wno-ignored-qualifiers \
  ...
  src/net/wifi.cpp src/net/webserver.cpp src/net/mqtt.cpp src/net/mqttHass.cpp src/net/mqttConfig.cpp src/storage/yokisLittleFS.cpp \
